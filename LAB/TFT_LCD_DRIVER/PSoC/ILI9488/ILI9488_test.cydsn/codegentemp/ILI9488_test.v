// ======================================================================
// ILI9488_test.v generated from TopDesign.cysch
// 02/27/2017 at 13:32
...
module top ;
    ...
    CyControlReg_v1_80 DDR_DATA (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam DDR_DATA.Bit0Mode = 0;
    defparam DDR_DATA.Bit1Mode = 0;
    defparam DDR_DATA.Bit2Mode = 0;
    defparam DDR_DATA.Bit3Mode = 0;
    defparam DDR_DATA.Bit4Mode = 0;
    defparam DDR_DATA.Bit5Mode = 0;
    defparam DDR_DATA.Bit6Mode = 0;
    defparam DDR_DATA.Bit7Mode = 0;
    defparam DDR_DATA.BitValue = 0;
    defparam DDR_DATA.BusDisplay = 1;
    defparam DDR_DATA.ExtrReset = 0;
    defparam DDR_DATA.NumOutputs = 1;
	...
	wire [7:0] tmpOE__DATA_net;
	wire [7:0] tmpFB_7__DATA_net;
	wire [7:0] tmpIO_7__DATA_net;
	...
	cy_psoc3_pins_v1_10
		...
		DATA
		 (.oe(tmpOE__DATA_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__DATA_net[7:0]}),
		  .io({tmpIO_7__DATA_net[7:0]}),
	...
	assign tmpOE__DATA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_74, Net_74, Net_74, Net_74, Net_74, Net_74, Net_74, Net_74} : {Net_74, Net_74, Net_74, Net_74, Net_74, Net_74, Net_74, Net_74};
	...
	cy_psoc3_pins_v1_10
		#(.id("6f05e902-8b1f-4dcf-937d-9d373593b510"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LCD_protected_RS_net;
	wire [0:0] tmpFB_0__LCD_protected_RS_net;
	wire [0:0] tmpIO_0__LCD_protected_RS_net;
	wire [0:0] tmpINTERRUPT_0__LCD_protected_RS_net;
	electrical [0:0] tmpSIOVREF__LCD_protected_RS_net;

	cy_psoc3_pins_v1_10
		#(.id("0d28c8a4-62bb-44d4-a86f-548a5efef471"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		LCD_protected_RS
		 (.oe(tmpOE__LCD_protected_RS_net),
		  .y({Net_91}),
		  .fb({tmpFB_0__LCD_protected_RS_net[0:0]}),
		  .io({tmpIO_0__LCD_protected_RS_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD_protected_RS_net),
		  .interrupt({tmpINTERRUPT_0__LCD_protected_RS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD_protected_RS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2d2750cc-d09c-48f9-be6e-a17f695aff7a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3665e8ed-800e-43d1-b692-608b602a985a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 Read_enable (
        .control_1(Net_81),
        .control_2(Net_82),
        .control_3(Net_83),
        .control_0(Net_102),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Read_enable.Bit0Mode = 0;
    defparam Read_enable.Bit1Mode = 0;
    defparam Read_enable.Bit2Mode = 0;
    defparam Read_enable.Bit3Mode = 0;
    defparam Read_enable.Bit4Mode = 0;
    defparam Read_enable.Bit5Mode = 0;
    defparam Read_enable.Bit6Mode = 0;
    defparam Read_enable.Bit7Mode = 0;
    defparam Read_enable.BitValue = 0;
    defparam Read_enable.BusDisplay = 0;
    defparam Read_enable.ExtrReset = 0;
    defparam Read_enable.NumOutputs = 1;

    CyControlReg_v1_80 LCD_RS (
        .control_1(Net_92),
        .control_2(Net_93),
        .control_3(Net_94),
        .control_0(Net_110),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LCD_RS.Bit0Mode = 0;
    defparam LCD_RS.Bit1Mode = 0;
    defparam LCD_RS.Bit2Mode = 0;
    defparam LCD_RS.Bit3Mode = 0;
    defparam LCD_RS.Bit4Mode = 0;
    defparam LCD_RS.Bit5Mode = 0;
    defparam LCD_RS.Bit6Mode = 0;
    defparam LCD_RS.Bit7Mode = 0;
    defparam LCD_RS.BitValue = 0;
    defparam LCD_RS.BusDisplay = 0;
    defparam LCD_RS.ExtrReset = 0;
    defparam LCD_RS.NumOutputs = 1;


    assign Net_104 = ~Net_102;


    assign Net_74 = Net_104 & Net_105;


    assign Net_91 = Net_110 | Net_104;
