...
#define number_0_SIZE 11
#define number_0_X 10
#define number_0_Y 8

static char number_0_GRAPH_NAME[] = "number_0";

static uint8 number_0_GRAPH[11] = {
126, 126, 102, 102, 102, 102, 102, 102, 126, 126, 0
};

#define number_1_SIZE 11
#define number_1_X 10
#define number_1_Y 8

static char number_1_GRAPH_NAME[] = "number_1";

static uint8 number_1_GRAPH[11] = {
6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 0
};

#define number_2_SIZE 11
#define number_2_X 10
#define number_2_Y 8

static char number_2_GRAPH_NAME[] = "number_2";

static uint8 number_2_GRAPH[11] = {
126, 126, 6, 6, 126, 126, 96, 96, 126, 126, 0
};

#define number_3_SIZE 11
#define number_3_X 10
#define number_3_Y 8

static char number_3_GRAPH_NAME[] = "number_3";

static uint8 number_3_GRAPH[11] = {
126, 126, 6, 6, 126, 126, 6, 6, 126, 126, 0
};

#define number_4_SIZE 11
#define number_4_X 10
#define number_4_Y 8

static char number_4_GRAPH_NAME[] = "number_4";

static uint8 number_4_GRAPH[11] = {
102, 102, 102, 102, 126, 126, 6, 6, 6, 6, 0
};

#define number_5_SIZE 11
#define number_5_X 10
#define number_5_Y 8

static char number_5_GRAPH_NAME[] = "number_5";

static uint8 number_5_GRAPH[11] = {
126, 126, 96, 96, 126, 126, 6, 6, 126, 126, 0
};

#define number_6_SIZE 11
#define number_6_X 10
#define number_6_Y 8

static char number_6_GRAPH_NAME[] = "number_6";

static uint8 number_6_GRAPH[11] = {
126, 126, 96, 96, 126, 126, 102, 102, 126, 126, 0
};

#define number_7_SIZE 11
#define number_7_X 10
#define number_7_Y 8

static char number_7_GRAPH_NAME[] = "number_7";

static uint8 number_7_GRAPH[11] = {
126, 126, 6, 6, 6, 6, 6, 6, 6, 6, 0
};

#define number_8_SIZE 11
#define number_8_X 10
#define number_8_Y 8

static char number_8_GRAPH_NAME[] = "number_8";

static uint8 number_8_GRAPH[11] = {
126, 126, 102, 102, 126, 126, 102, 102, 126, 126, 0
};

#define number_9_SIZE 11
#define number_9_X 10
#define number_9_Y 8

static char number_9_GRAPH_NAME[] = "number_9";

static uint8 number_9_GRAPH[11] = {
126, 126, 102, 102, 126, 126, 6, 6, 6, 6, 0
};
